...
public class vendeur extends Fragment {
     ...
     * @return A new instance of fragment Vendeur.
     */
    // TODO: Rename and change types and number of parameters
    public static vendeur newInstance(String param1 , String param2) {
        vendeur fragment = new vendeur ();
    ...
    public View onCreateView(LayoutInflater inflater , ViewGroup container , Bundle savedInstanceState) {
        ...
        View rootView= inflater.inflate ( R.layout.fragment_vendeur , container , false );
        ...
        protected String doInBackground(String... strings) {
            ...
            try {
                ...
                if (con == null) {
                    ...
                    String q = "SELECT nom,type FROM UsersAndroid where type =2";
